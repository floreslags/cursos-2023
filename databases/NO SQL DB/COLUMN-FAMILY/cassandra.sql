HELP;
-- KEYSPACES PERMITE DEFINIR EL USUARIO DE ACCESO
DESC KEYSPACES;
USE KEYSPACE_NAME;

-- NOS PERMITE CONSULTAR LAS TABLAS DENTRO DE LA DB
DESC TABLES;
...
UPDATE users SET email = 'newemail@example.com' WHERE user_id = 79407b9f-f860-4e92-a8dd-0d01d03cad03;

DELETE FROM users WHERE user_id = <user_id>;
DELETE FROM users WHERE user_id = dd887140-50dc-4c67-86ba-15f16315edfb;